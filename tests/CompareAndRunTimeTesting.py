...
from tests.JavaResults import JavaResults as j_res
...
def comp_run_time(file_name, all_comp_java, key_comp_1, comp1_java):
    """
    ...
    :param all_comp_java: the conencted coponents of the graph as caculated in hava
    :param key_comp_1: the id of the first node to find the connectent component of.
    :param comp1_java: the comp from java- to compare the results to.
    :return:
    """
...
def strongly_comp_check():
    ...
    comp_run_time("../Graphs_on_circle/G_30000_240000_1.json", j_res.graph_G_30000_240000_1_all_comp, 0,
                  j_res.graph_G_30000_240000_1_comp1)
